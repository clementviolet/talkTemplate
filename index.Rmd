...
### <b>Clément Violet</b>, .small[DYNECO - LEBCO <br> + Collaborators]

<br><br><br>

[<i class="fa fa-github fa-lg" style="color:#e7e8e2"></i> clementviolet/talkTemplate](https://github.com/clementviolet/talkTemplate)

[<i class="fa fa-twitter fa-lg" style="color:#e7e8e2"></i> @ClementVIOLET](https://twitter.com/willvieira90)
...
.code70[
```{markdown}
.citeb[Talluto et al. [2017](https://link) Nat. Ecol. Evol.]
```
]

.center[![:scale 70%](images/Talluto1.png)]

.citeb[Talluto et al. [2017](https://www.nature.com/articles/s41559-017-0182) Nat. Ecol. Evol.]

---
# Citation

Or you can aad a citation at the bottom of an object (i.e: code block, text, citation.)

.code70[
```{markdown}
.citeh[Talluto et al. [2017](https://link) Nat. Ecol. Evol.]
```
]

.citeh[Talluto et al. [2017](https://www.nature.com/articles/s41559-017-0182) Nat. Ecol. Evol.]
